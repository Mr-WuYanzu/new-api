...
Route::middleware(['access_token','Token'])->group(function(){
    //显示客户端ip
        Route::get('/clientip','api\ApiController@client_ip')->middleware(['Token','access_token']);
    //显示客户端UA
        Route::get('/clientua','api\ApiController@clientua')->middleware(['Token','access_token']);
    //显示客户端UA
